...
const TYPE_COPY: Record<QuestionType, TypeCopy> = {
  research_fact: {
    ...
    priority: ["정확성이 가장 중요해요", "최신성이 중요해요", "비교가 중요해요", "출처가 중요해요"],
  ...
  concept_learning: {
    ...
    priority: ["쉽게 이해하는 게 중요해요", "예시가 중요해요", "실제로 쓰는 법이 중요해요", "헷갈림을 푸는 게 중요해요"],
  ...
  perspective_interpretation: {
    ...
    priority: ["새로운 관점이 중요해요", "균형 잡힌 판단이 중요해요", "반대 의견이 중요해요", "글감으로 쓰는 게 중요해요"],
  ...
  idea_generation: {
    ...
    priority: ["새로움이 중요해요", "실행 쉬움이 중요해요", "돈이 적게 드는 게 중요해요", "차별점이 중요해요"],
  ...
  strategy_business: {
    ...
    priority: ["돈이 될지가 중요해요", "첫 고객 찾기가 중요해요", "차별점이 중요해요", "작게 시험하는 게 중요해요"],
  ...
  decision_comparison: {
    ...
    priority: ["안전함이 중요해요", "성장 가능성이 중요해요", "돈이 중요해요", "시간을 아끼는 게 중요해요"],
  ...
  problem_diagnosis: {
    ...
    priority: ["진짜 원인이 중요해요", "빨리 고치는 게 중요해요", "반복을 막는 게 중요해요", "돈 적게 드는 게 중요해요"],
  ...
  critique_risk: {
    ...
    priority: ["가장 큰 위험이 중요해요", "반대 의견이 중요해요", "고칠 방법이 중요해요", "현실성이 중요해요"],
  ...
  execution_roadmap: {
    ...
    priority: ["오늘 할 일이 중요해요", "순서가 중요해요", "역할 나누기가 중요해요", "막히는 지점이 중요해요"],
  ...
  artifact_creation: {
    ...
    priority: ["읽기 쉬움이 중요해요", "설득력이 중요해요", "빠짐없이 담는 게 중요해요", "바로 쓰는 게 중요해요"],
...
const purposeQuestion = (purpose: FollowupPurpose, subject: string) => {
  const questions: Record<FollowupPurpose, string> = {
    ...
    priority_or_focus: "이번 답에서 가장 중요하게 봐야 할 것은 무엇인가요?",
...
const purposeChoices = (copy: TypeCopy, purpose: FollowupPurpose) => {
  const choices: Record<FollowupPurpose, string[]> = {
    ...
    priority_or_focus: copy.priority,
